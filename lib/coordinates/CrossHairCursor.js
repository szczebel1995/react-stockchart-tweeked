		...
		value: function drawOnCanvas(ctx, moreProps) {
			...
			if ((0, _utils.isDefined)(lines)) {
				...
				lines.forEach(function (line) {
					...
					var grd = ctx.createLinearGradient(0, 0, 0, line.y2 - 5);
					//Todo find the width of the whole screen should be equal to the end.
					grd.addColorStop("1", "#0e4572");
					grd.addColorStop("0", "#071F30");
					ctx.strokeStyle = grd;
