...
function drawOnCanvas(ctx, props) {
	...
	if ((0, _utils.isDefined)(edge.coordinateBase)) {
		...
		if(!edge.line.isEdge && !edge.line.isPriceHighlight){//Price coordinate text.
			...
			ctx.fillText(edge.line.highlightTitle, edge.coordinate.edgeXText - 120, edge.coordinate.edgeYText - 4);
			ctx.fillStyle = "#e8e9ea";
			ctx.font = '600 16px Ubuntu Helvetica Neue, Helvetica, Arial, sans-serif';
			ctx.fillText(edge.line.highlightPrice, edge.coordinate.edgeXText - 145, edge.coordinate.edgeYText + 13);
		}
	}
